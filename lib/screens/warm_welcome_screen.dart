...
import 'package:healthblocks/managers/welcome_manager.dart';
      ...
      holders = <SecondaryWidgetHolder>[
        new SecondaryWidgetHolder(
          ...
          child: new ScaleTransition(
            ...
            child: new SvgPicture.asset(_steps[index].imageUris[1], height: 55.0, allowDrawingOutsideViewBox: false),
          ),
        ),
        new SecondaryWidgetHolder(
          top: 70.0,
          ...
          child: new ScaleTransition(
            ...
            child: new SvgPicture.asset(_steps[index].imageUris[2], height: 40.0, allowDrawingOutsideViewBox: false),
          ),
        ),
        new SecondaryWidgetHolder(
          bottom: 70.0,
          ...
          child: new ScaleTransition(
            ...
            child: new SvgPicture.asset(_steps[index].imageUris[3], height: 35.0, allowDrawingOutsideViewBox: false),
          ),
        ),
        new SecondaryWidgetHolder(
          bottom: 10.0,
          ...
          child: new ScaleTransition(
            ...
            child: new SvgPicture.asset(_steps[index].imageUris[4], height: 30.0, allowDrawingOutsideViewBox: false),
          ),
        ),
      ];
    } else if (index == 3) {
